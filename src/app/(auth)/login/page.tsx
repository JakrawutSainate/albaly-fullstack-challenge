...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Mock login logic - in real app call /api/auth/login or Server Action
        // For now we just set the cookie manually to satisfy middleware
        document.cookie = "auth_session=mock-token; path=/; max-age=3600";
